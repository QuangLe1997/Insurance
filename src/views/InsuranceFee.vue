<template>
  <v-col sm="12" md="5" lg="4" xl="3" class="work-space">
    <v-row dense class="mt-8 d-flex justify-space-around align-center">
      <v-col cols="5">
    ...
    <v-dialog v-model="showNoti" max-width="400px">
      <v-card>
        ...
        <v-card-text class="mb-1">
          <div class="noty-body">
            <span class="text-noty">Dòng xe này được ưu đãi lên đến 30%.</span>
            <br />
            <span class="text-noty">
              Chúng tôi sẽ gọi báo giá tốt nhất cho Quý khách
            </span>
          </div>
        </v-card-text>
